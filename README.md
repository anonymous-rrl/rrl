...
This is a PyTorch implementation of Rule-based Representation Learner (RRL) as described in our paper:
...
```
The training log file (`log.txt`) can be found in a folder created in `log_folder`. In this example, the folder is 
```
tic-tac-toe_e401_bs32_lr0.002_lrdr0.75_lrde200_wd1e-06_ki0_rc0_useNOTFalse_saveBestFalse_estimatedGradFalse_L1@16
```
...
```
Class: class_negative,  bias = -2.1733
...
Class: class_positive,  bias = 1.9689
...
optional arguments:
  ...
  -d DATA_SET, --data_set DATA_SET
                        ...
                        the dataset folder are available. (default: tic-tac-toe)
  ...
  -s STRUCTURE, --structure STRUCTURE
                        ...
                        logical layers. E.g., 10@64, 10@64@32@16. (default: 5@64)
